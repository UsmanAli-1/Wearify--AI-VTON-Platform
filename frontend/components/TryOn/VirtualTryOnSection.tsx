...
//               {/* UPLOAD PERSON CARD */}
//               <Card
//                 className="relative h-[250px] md:h-[363px] 2xl:min-h-[450px] py-0 md:py-5  flex items-center justify-center
...
//                   {uploadedImage ? (
//                     // ← wrapped in relative div to position X button
//                     // REPLACE with this:
...
//               <Card
//                 className="relative h-[250px] md:h-[363px] 2xl:min-h-[450px] py-0 md:py-5  flex items-center justify-center text-center rounded-2xl shadow-md 
//                 hover:scale-105 duration-300 transition bg-white/5 backdrop-blur-md border border-white/10"
//               >
...
//           <Card
//             className="rounded-3xl w-full p-7 h-[400px] md:h-[450px] 2xl:min-h-[580px] flex items-center justify-center
